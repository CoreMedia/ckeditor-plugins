...
export const XLINK_NAMESPACE_PREFIX: KnownNamespacePrefix = "xlink";
export const XML_NAMESPACE_PREFIX: KnownNamespacePrefix = "xml";
export const XML_NAMESPACE_URI = namespaces.xml;

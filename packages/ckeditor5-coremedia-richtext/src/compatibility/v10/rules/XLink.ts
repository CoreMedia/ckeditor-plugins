import type { ElementProxy, AttributeMapper } from "@coremedia/ckeditor5-dataprocessor-support";
import { preserveAttributeAs, renameAttribute } from "@coremedia/ckeditor5-dataprocessor-support";

import type { ViewNode, ViewDocumentFragment } from "ckeditor5";
import { ViewElement, ViewText, UpcastWriter } from "ckeditor5";
...
import type { FontMapping } from "./FontMapping";

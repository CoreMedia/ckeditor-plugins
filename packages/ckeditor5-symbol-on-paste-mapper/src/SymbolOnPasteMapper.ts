...
import {coremedia} from "@coremedia/coremedia-utils/src";
...
class SymbolOnPasteMapper extends Plugin {
  ...
  private readonly logger = coremedia.getLogger(SymbolOnPasteMapper.pluginName);

  constructor(ed: editor.Editor) {
    super(ed);
  }

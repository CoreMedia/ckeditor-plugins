...
* [CoreMedia RichText 1.0 Integration](#coremedia-richtext-1)

## Integration

[[Top](#_top)|[Integration](#integrate)|[Configuration](#config)|[RichText](#coremedia-richtext-1)] <a id="integrate"></a>
...
[[Top](#_top)|[Integration](#integrate)|[Configuration](#config)|[RichText](#coremedia-richtext-1)] <a id="config"></a>
...
[[Top](#_top)|[Up](#config)|[Default Configuration](#config-default)|[Advanced Configuration](#config-advanced)] <a id="config-default"></a>
...
CoreMedia RichText 1.0 for example, see [below](#coremedia-richtext-1)). It is
represented similar to the standard target names with an underscore as prefix.

#### Predefined: _other (Recommended)
...
It is strongly recommended adding at least `_other` to your configuration, as it
serves as fallback for any otherwise unknown value of `linkTarget`. Thus, if
your model includes `linkTarget="_self"` without `_self` being part of your
configuration, this option will become active and provide an editor
containing `_self` as text.
...
1.0 integration (see [below](#coremedia-richtext-1)). It represents an
artificial state having `xlink:show="other"` without expected `xlink:role`
attribute.
...
[[Top](#_top)|[Up](#config)|[Default Configuration](#config-default)|[Advanced Configuration](#config-advanced)] <a id="config-advanced"></a>
...
[[Top](#_top)|[Integration](#integrate)|[Configuration](#config)|[RichText](#coremedia-richtext-1)] <a id="coremedia-richtext-1"></a>
...
the [Advanced Configuration](#config-advanced).
...
decide to provide an [Advanced Configuration](#config-advanced) for these
combined targets.

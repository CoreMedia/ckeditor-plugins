...
/**
 * Adds or removes "cm-ck-link-form-view--show-content-link" to the form view's element or to the form view's
 * template if the view is not rendered yet. This affects whether the content or external link field is shown.
 *
...
export const showContentLinkField = (view: View, show: boolean): void => {
  const showContentLinkFieldClass = "cm-ck-link-form-view--show-content-link";

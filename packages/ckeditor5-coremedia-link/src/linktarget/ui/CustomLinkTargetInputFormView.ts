...
export default class CustomLinkTargetInputFormView extends View {
  ...
  constructor(linkTargetCommand: Command, locale?: Locale) {
     ...
     */
    this.saveButtonView = this.#createButton(t?.("Save") ?? "Save", IconCheck, "ck-button-save");
     ...
     */
    this.cancelButtonView = this.#createButton(t?.("Cancel") ?? "Cancel", IconCancel, "ck-button-cancel", "cancel");
     ...
     * @readonly
     */
    this.#focusables = new ViewCollection<FocusableView>();

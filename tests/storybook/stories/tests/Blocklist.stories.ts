...
/**
 * Dedicated scenario for `Blocklist.test.ts`: an empty CoreMedia RichText
 * editor (the richtext factory loads the Blocklist plugin). Text, selection and
 * blocked words are applied per test at runtime via the in-page editor test API.
 */

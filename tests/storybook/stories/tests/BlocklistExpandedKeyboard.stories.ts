...
/**
 * Dedicated scenario for `BlocklistExpandedKeyboard.test.ts`: an empty CoreMedia
 * RichText editor. Blocked words and text are applied per test at runtime via
 * the in-page editor test API.
 */

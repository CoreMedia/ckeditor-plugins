 ...
 *
 * Per migration decision, this handle-based wrapper is migrated as-is and is
 * intentionally not replaced by a functional helper.
 */
export class MockInputExamplePluginWrapper extends JSWrapper<MockInputExamplePlugin> {
  ...
  /**
   * Provides access to the plugin via Editor.
   *
